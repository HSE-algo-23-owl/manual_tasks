...
Поскольку это дерево покрывает вершины D, B, C, 5 и 2 то множество X = {D, B, C}, а множество Y = {2, 5}.
Минимальный элемент в строках D, B, C и столбцах 1, 3, 4 в преобразованной матрице затрат равен единице.
Вычитая единицу из строк D, B, C и добавляя к столбцам 2, 5 получаем новую матрицу затрат.
